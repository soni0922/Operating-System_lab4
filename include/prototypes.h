...
extern	void pfISRdispatcher(void);
extern interrupt pfISRHandler(void);
extern int find_bs_page(pid32 pid, unsigned long virtual_page_no, bsd_t * bs_store_id, int32 * bs_page_offset);
...
extern void settingcr3(unsigned long pdbr);
extern void enable_paging();
extern void invalidate_tlb_entry(unsigned long n);
extern void initialize_frames();
extern int evict_frame_fifo();
extern int detach_link(int found_frameId, pid32 next_pid);
extern int get_free_frame(int page_type, pid32   pid, int vpageNo);

extern void create_new_page_table(pt_t * pt_ptr);
extern pd_t * init_page_dir(int frame_id,pid32 pid);
